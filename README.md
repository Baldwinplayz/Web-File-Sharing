...
1. Install the dependencies
   run `pip install flask | pip install html | pip install pyopenssl | pip install "qrcode[pil]" | pip install termcolor | pip install psutil` Note that you might have problems installing `html`.
